...
public:
    ...
    void OnUnitUpdate(Unit* unit, uint32 /*diff*/) override
    {
        ...
        // Alpha's original Titan family is enemy-side energy. Beta/Gamma Purified Titan Energy,
        // Keepers, Crushers and Sanity are owned exclusively by TitanRuneTitan/PurifiedEnergy.

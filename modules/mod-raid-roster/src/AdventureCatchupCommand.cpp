...
// Targets are deliberately entry-ready / previous-tier-ish rather than current-tier loot.
// AutoGear runs incrementally, so gear already better than the target is kept.

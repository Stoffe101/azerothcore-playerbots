...
void RecordBossKill(Player* player, Creature* boss)
{
    ...
    CharacterDatabase.DirectExecute(
        ...
        "(player_guid, guild_id, map_id, instance_id, creature_entry, difficulty, group_size) "
        "VALUES ({}, {}, {}, {}, {}, {}, {})",
        playerGuid, guildId, mapId, instanceId, creatureEntry, uint32(difficulty), uint32(groupSize));
    ...
    CharacterDatabase.DirectExecute(
        ...
        "(player_guid, map_id, creature_entry, difficulty, first_guild_id, last_guild_id, first_group_size, last_group_size, clear_count) "
        "VALUES ({}, {}, {}, {}, {}, {}, {}, {}, 1) "
        ...
        playerGuid, mapId, creatureEntry, uint32(difficulty), guildId, guildId, uint32(groupSize), uint32(groupSize));
}
}

...
local menu = {
    ...
    { text = "Rate presets", notCheckable = true, hasArrow = true, menuList = {
        { text = "Normal (1x XP / 1x rep)", notCheckable = true, func = function() Run(".playstyle preset normal") end },
        { text = "Boosted (1.5x XP / 1.5x rep)", notCheckable = true, func = function() Run(".playstyle preset boosted") end },
        { text = "Fast (2x XP / 2x rep)", notCheckable = true, func = function() Run(".playstyle preset fast") end },
        { text = "Turbo (3x XP / 3x rep)", notCheckable = true, func = function() Run(".playstyle preset turbo") end },
        { text = "Insane (5x XP / 5x rep)", notCheckable = true, func = function() Run(".playstyle preset insane") end },
    } },
    { text = "XP multiplier", notCheckable = true, hasArrow = true, menuList = RateMenu("xp") },
    { text = "Gold multiplier: 1.0x (source-safe)", notCheckable = true, disabled = true },
...
btn:SetScript("OnEnter", function(self)
    ...
    GameTooltip:AddLine("XP, reputation, quests, raid skips and catch-up gear.", 1, 1, 1)
    GameTooltip:AddLine("Gold stays at the realm rate so transfers cannot duplicate currency.", 0.75, 0.75, 0.75)

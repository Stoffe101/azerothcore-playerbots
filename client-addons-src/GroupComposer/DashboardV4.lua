...
local buildEditor=Panel(frame,C.chrome,C.blue); buildEditor:SetFrameStrata("TOOLTIP"); buildEditor:SetWidth(430); buildEditor:SetHeight(270); buildEditor:SetPoint("CENTER"); buildEditor:Hide()

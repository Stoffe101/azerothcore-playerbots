...
15d. **CURRENT / local CI:** authoritative worldserver character snapshot + private service validation. Server owns era/level/class/role/talents/gear/enchants/gems/glyphs/professions; service routes only to AVAILABLE_UNVALIDATED semantic models. NEXT after green: validated preset/request construction and asynchronous candidate-item comparison transport.

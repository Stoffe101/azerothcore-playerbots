...
15a. **PARALLEL CLIENT POLISH / CI TODO:** GearAdvisor v0.2.0 layout/data polish is prepared; run exact-head CI, then validate alignment/tooltips/spec icon/left-right anchoring in the real client.

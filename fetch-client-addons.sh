...
# Locally-authored addons (version-controlled under client-addons-src/, not downloaded).
# Stage them alongside the downloaded addons so the generated client pack always includes them.
